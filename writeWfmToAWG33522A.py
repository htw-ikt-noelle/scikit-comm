...
#def write_samples_AWG33522A(user_inputs, ipAdress,channel,nSamples,samples,SampleRate,Amp_PP, Offset, filter_settings = None):
def write_samples_AWG33522A(user_attributes, samples, SampleRate=62.5e6 ,channel=1, Amp_PP=3.0, Offset=1.0, filter_settings="normal"): 
...
# =============================================================================
    ...
    if hasattr(user_attributes, 'channel') == False:
...
# =============================================================================
    ...
    if channel == 1:
        ...
        awg.write(':SOURce%d:APPLy:ARBitrary %s,%s,%s' % (channel, SampleRate, Amp_PP, Offset))
...
# =============================================================================
    ...
    if channel == 2:
        ...
        awg.write_binary_values(':SOURce2:DATA:ARBitrary:DAC %s,' % ('arb2' ),samples, datatype = 'h', is_big_endian = False )
        ...
        if SampleRate <= 62.5e6 and filter_settings.lower() == "off" and channel == 2:
