...
#     test_two_traces = comm.instrument_control.get_samples_HP_71450B_OSA(traces = ['A'], GPIB_address='4', log_mode=False)
#     # Get trace data
...
#     print('Start wavelength: ' + str(test_one_trace_Start_WL)) 
#     # Get stop WL
#     test_two_traces_Stop_WL = test_two_traces[trace]['Start_WL']
#     print('Stop wavelength: ' + str(test_one_trace_Stop_WL)) 
#     # Get wavelength vector
...
#     test_three_traces = comm.instrument_control.get_samples_HP_71450B_OSA(traces = ['A'], GPIB_address='4', log_mode=False)
#     # Get trace data
...
#     print('Start wavelength: ' + str(test_one_trace_Start_WL)) 
#     # Get stop WL
#     test_three_traces_Stop_WL = test_three_traces[trace]['Start_WL']
#     print('Stop wavelength: ' + str(test_one_trace_Stop_WL)) 
#     # Get wavelength vector
